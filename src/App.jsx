  ...
  <section className="relative pt-14 sm:pt-16 min-h-screen flex flex-col overflow-hidden" style={{ background: 'linear-gradient(180deg, #ffffff 0%, #f0f9ff 30%, #e0f2fe 70%, #dbeafe 100%)' }}>
    ...
    <div className="relative flex-1 flex flex-col justify-center">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-16 lg:py-20">
        {/* 上部：キャッチコピーとイラストを左右に配置（バランス改善） */}
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-10 items-center mb-12 sm:mb-16">
          
          {/* 左側：メインコピー（フォント大きく、やや右寄せ） */}
          <div className="text-center lg:text-left order-2 lg:order-1 flex items-center justify-center lg:justify-end lg:pr-8">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-6xl font-bold leading-tight" style={{ color: COLORS.primaryDark, fontFamily: "'Noto Serif JP', serif" }}>
              あなたの店舗の<br />
  ...
  <footer className="py-10 sm:py-14 px-4 sm:px-6" style={{ backgroundColor: COLORS.primaryDark }}>
    <div className="max-w-4xl mx-auto text-center">
      <a href="/" onClick={(e) => { e.preventDefault(); if (onLogoClick) onLogoClick(); }} className="inline-flex items-center justify-center gap-3 mb-5 cursor-pointer">
        <img src={LOGO_URL} alt="のれん診断ロゴ" className="h-12 sm:h-14 w-auto brightness-0 invert opacity-90" onError={(e) => { e.target.style.display = 'none'; }} />
