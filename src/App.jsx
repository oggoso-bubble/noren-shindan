  ...
  <header className="fixed top-0 left-0 right-0 z-50 shadow-lg" style={{ backgroundColor: COLORS.headerBg }}>
    <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between">
      <a href="/" onClick={(e) => { e.preventDefault(); if (onLogoClick) onLogoClick(); }} className="flex items-center gap-2 cursor-pointer">
        <img src={LOGO_URL} alt="のれん診断" className="h-8 sm:h-10 w-auto" onError={(e) => { e.target.style.display = 'none'; }} />
      </a>
      ...
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1 lg:pr-8">
            {/* メインコピー */}
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-bold leading-tight mb-6 sm:mb-8" style={{ color: COLORS.primaryDark, fontFamily: "'Noto Serif JP', serif" }}>
              あなたの店舗の<br />
            ...
            <div className="mb-5 sm:mb-6">
              <button 
                onClick={onStartDiagnosis} 
                className="group px-8 sm:px-10 py-4 rounded-2xl font-bold text-base sm:text-lg shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2 mx-auto"
          ...
          <div className="flex justify-center lg:justify-end order-1 lg:order-2">
            <div className="relative">
              ...
              {/* PC本体 */}
              <div className="relative mt-8 sm:mt-10" style={{ width: '400px', maxWidth: '95vw' }}>
              ...
              {/* スマホ（適切な比率） */}
              <div className="absolute -right-2 sm:-right-6 bottom-6 sm:bottom-8 w-20 sm:w-24 bg-gray-900 rounded-2xl p-1 shadow-xl transform rotate-3">
                <div className="bg-white rounded-xl overflow-hidden">
                  {/* ステータスバー */}
                  <div className="h-4 flex items-center justify-center" style={{ backgroundColor: COLORS.accent }}>
                    <span className="text-white text-[7px] font-bold">のれん診断</span>
                  </div>
                  {/* コンテンツ */}
                  <div className="p-2">
                    <p className="text-[6px] text-gray-500 text-center mb-1">推定売却価格</p>
                    <p className="text-base font-bold text-center" style={{ color: COLORS.accent }}>
...
// Footer（ロゴ中央表示）
// ========================================
const Footer = ({ onContactClick, onTermsClick, onPrivacyClick }) => (
  <footer className="py-10 sm:py-14 px-4 sm:px-6" style={{ backgroundColor: COLORS.primaryDark }}>
    <div className="max-w-4xl mx-auto text-center">
      <div className="mb-5">
        <img src={LOGO_URL} alt="のれん診断" className="h-10 sm:h-12 w-auto mx-auto brightness-0 invert opacity-90" onError={(e) => { e.target.style.display = 'none'; }} />
      </div>
    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8">
        ...
        <div className="prose prose-sm max-w-none text-sm leading-relaxed" style={{ color: COLORS.gray700 }}>
          <p className="mb-4">本利用規約（以下「本規約」）は、のれん診断（以下「本サービス」）の利用条件を定めるものです。ご利用の前に必ずお読みください。</p>
          
          <h2 className="text-base font-bold mt-6 mb-3" style={{ color: COLORS.primaryDark }}>第1条（適用）</h2>
          <p className="mb-4">本規約は、本サービスの利用に関わる一切の関係に適用されるものとします。</p>
          
          <h2 className="text-base font-bold mt-6 mb-3" style={{ color: COLORS.primaryDark }}>第2条（サービス内容）</h2>
          <p className="mb-4">本サービスは、飲食店の売却価格の目安を算出する無料診断サービスです。診断結果は参考情報であり、実際の売却価格を保証するものではありません。</p>
          
          <h2 className="text-base font-bold mt-6 mb-3" style={{ color: COLORS.primaryDark }}>第3条（免責事項）</h2>
          <p className="mb-4">本サービスで提供される診断結果は、入力された情報に基づく概算であり、実際の売却価格とは異なる場合があります。本サービスの利用により生じたいかなる損害についても、当方は一切の責任を負いません。</p>
          
          <h2 className="text-base font-bold mt-6 mb-3" style={{ color: COLORS.primaryDark }}>第4条（禁止事項）</h2>
          <p className="mb-4">本サービスの不正利用、システムへの過度な負荷をかける行為、その他当方が不適切と判断する行為を禁止します。</p>
          
          <h2 className="text-base font-bold mt-6 mb-3" style={{ color: COLORS.primaryDark }}>第5条（規約の変更）</h2>
          <p className="mb-4">当方は、必要と判断した場合には、本規約を変更することができるものとします。</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="min-h-screen pt-16 sm:pt-20 pb-8 px-4 sm:px-6" style={{ backgroundColor: COLORS.gray50 }}>
    <div className="max-w-3xl mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8">
        ...
        <div className="prose prose-sm max-w-none text-sm leading-relaxed" style={{ color: COLORS.gray700 }}>
          <p className="mb-4">のれん診断（以下「本サービス」）は、ユーザーのプライバシーを尊重し、個人情報の保護に努めます。</p>
          
          <h2 className="text-base font-bold mt-6 mb-3" style={{ color: COLORS.primaryDark }}>1. 収集する情報</h2>
          <p className="mb-4">本サービスでは、診断に必要な店舗情報（店舗数、年商、営業利益等）を入力いただきますが、これらの情報はサーバーに保存されません。診断完了後、入力データは自動的に破棄されます。</p>
          
          <h2 className="text-base font-bold mt-6 mb-3" style={{ color: COLORS.primaryDark }}>2. 情報の利用目的</h2>
          <p className="mb-4">入力された情報は、売却価格の診断結果を算出するためにのみ使用されます。</p>
          
          <h2 className="text-base font-bold mt-6 mb-3" style={{ color: COLORS.primaryDark }}>3. 第三者への提供</h2>
          <p className="mb-4">本サービスでは、ユーザーの情報を第三者に提供することはありません。</p>
          
          <h2 className="text-base font-bold mt-6 mb-3" style={{ color: COLORS.primaryDark }}>4. アクセス解析</h2>
          <p className="mb-4">本サービスでは、サービス改善のためにアクセス解析ツールを使用する場合があります。これにより収集されるデータは統計情報であり、個人を特定するものではありません。</p>
          
          <h2 className="text-base font-bold mt-6 mb-3" style={{ color: COLORS.primaryDark }}>5. お問い合わせ</h2>
          <p className="mb-4">プライバシーポリシーに関するお問い合わせは、お問い合わせページよりご連絡ください。</p>
        </div>
      </div>
    </div>
  </div>
  ...
  return (
    <ErrorBoundary>
      <div className="font-sans antialiased" style={{ color: COLORS.gray900 }}>
        ...
        <Footer onContactClick={handleContactClick} onTermsClick={handleTermsClick} onPrivacyClick={handlePrivacyClick} />
      </div>
    </ErrorBoundary>
  );
};
