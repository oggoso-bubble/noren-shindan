...
const SEOHead = () => {
  useEffect(() => {
    ...
    favicon.href = '/images/logo.png?v=3';
    
    // Apple Touch Icon（iOS用）
    let appleIcon = document.querySelector('link[rel="apple-touch-icon"]');
    if (!appleIcon) { appleIcon = document.createElement('link'); appleIcon.rel = 'apple-touch-icon'; document.head.appendChild(appleIcon); }
    appleIcon.href = '/images/logo.png?v=3';
  ...
  <section className="relative pt-14 sm:pt-16 min-h-screen flex flex-col overflow-hidden" style={{ background: 'linear-gradient(180deg, #ffffff 0%, #f0f9ff 30%, #e0f2fe 70%, #dbeafe 100%)' }}>
    ...
    <div className="relative flex-1 flex flex-col justify-center">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 lg:py-20">
        {/* 上部：キャッチコピーとイラストを左右に配置（中央揃え、右寄せ） */}
        <div className="flex justify-center mb-12 sm:mb-16">
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-center lg:pl-16 xl:pl-24">
            
            {/* 左側：メインコピー（デスクトップ画面の縦中央に合わせる） */}
            <div className="text-center lg:text-left order-2 lg:order-1 flex items-center justify-center lg:justify-end lg:pr-8 lg:pt-8">
