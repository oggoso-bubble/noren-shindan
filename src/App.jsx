...
// ========================================
// Hero Section（上部に左右配置、下部に説明文とCTA中央）
// ========================================
  ...
  <section className="relative pt-14 sm:pt-16 min-h-screen flex flex-col overflow-hidden" style={{ background: 'linear-gradient(180deg, #ffffff 0%, #f0f9ff 30%, #e0f2fe 70%, #dbeafe 100%)' }}>
    ...
    <div className="relative flex-1 flex flex-col">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        {/* 上部：キャッチコピーとイラストを左右に配置 */}
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-start mb-6 sm:mb-8">
          
          {/* 左側：メインコピー */}
          <div className="text-center lg:text-left order-2 lg:order-1 flex items-center">
          ...
          <div className="flex justify-center lg:justify-end order-1 lg:order-2">
            <div className="relative">
              ...
              {/* PC本体 */}
              <div className="relative mt-8 sm:mt-10" style={{ width: '380px', maxWidth: '90vw' }}>
                <div className="bg-gray-800 rounded-t-xl p-1.5 shadow-2xl">
                  ...
                  {/* 画面コンテンツ */}
                  <div className="bg-white p-4" style={{ minHeight: '180px' }}>
              ...
              {/* スマホ（適切な縦長比率） */}
              <div className="absolute -right-2 sm:-right-6 bottom-4 sm:bottom-6 w-20 sm:w-24 bg-gray-900 rounded-2xl p-1 shadow-xl transform rotate-3">
        ...
        <div className="max-w-4xl mx-auto text-center mb-6 sm:mb-8">
          <p className="text-sm sm:text-base md:text-lg leading-relaxed mb-3" style={{ color: COLORS.gray600 }}>
            「のれん診断」は、飲食店オーナー様が売却を検討される際の第一歩として、店舗の適正な売却価格を無料で診断できるサービスです。
          </p>
          <p className="text-sm sm:text-base md:text-lg leading-relaxed" style={{ color: COLORS.gray600 }}>
