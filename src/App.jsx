...
const LOGO_URL = 'https://raw.githubusercontent.com/oggoso-bubble/noren-shindan/main/public/images/logo.png';
...
const SEOHead = () => {
  useEffect(() => {
    ...
    favicon.href = 'https://raw.githubusercontent.com/oggoso-bubble/noren-shindan/main/public/images/logo.png';
    ...
    appleIcon.href = 'https://raw.githubusercontent.com/oggoso-bubble/noren-shindan/main/public/images/logo.png';
    ...
    <div className="relative flex-1 flex flex-col justify-center">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 lg:py-20">
        ...
        <div className="flex justify-center mb-12 sm:mb-16">
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-center lg:translate-x-16 xl:translate-x-24">
